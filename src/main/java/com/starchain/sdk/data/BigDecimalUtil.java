package com.starchain.sdk.data;
...
public class BigDecimalUtil {
    ...
    public final static int TRADE_SCALE = 8;
    /**
     * 基本单位
     */
    ...
    public static BigDecimal add(BigDecimal a, BigDecimal b){
        ...
        if(a == null) return b;
        if(b == null) return a;
        return a.add(b).setScale(TRADE_SCALE,BigDecimal.ROUND_DOWN);
    }
    ...
    public static BigDecimal sub(BigDecimal a, BigDecimal b){
        ...
        if(b == null) return a;
        return a.subtract(b).setScale(TRADE_SCALE,BigDecimal.ROUND_DOWN);
    }

    public static BigDecimal mul(BigDecimal a, BigDecimal b){
        if(a == null || b == null)return BigDecimal.ZERO;
        return a.multiply(b).setScale(TRADE_SCALE,BigDecimal.ROUND_DOWN);
    }

    public static BigDecimal div(BigDecimal a, BigDecimal b){
        return a.divide(b,TRADE_SCALE,BigDecimal.ROUND_DOWN);
    }
